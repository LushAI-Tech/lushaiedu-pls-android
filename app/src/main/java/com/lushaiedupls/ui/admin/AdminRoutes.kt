...
object AdminRoutes {
    ...
    const val FEES = "admin_fees"
    const val FEES_CREATE_CLASS = "admin_fees_create_class"
    const val FEES_CREATE_SUBJECT = "admin_fees_create_subject"
    const val FEEDBACK = "admin_feedback"
    const val INVITES = "admin_invites"
